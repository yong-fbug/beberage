      ...
      >
        ...
        >
          <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center">
            <h2 className="text-3xl font-bold mb-4 text-teal-500 dark:text-teal-500">Inventory Access</h2>
        ...
        <div className="relative w-full sm:w-1/2 max-w-lg min-h-full flex justify-center items-center">
          <AnimatePresence mode="wait">
            ...
            >
              <h2 className="text-3xl font-bold text-center text-teal-500 dark:text-gray-200">Log-in</h2>
